...
TRAIN_DIR="/home/muffadall/work/github_repo/tensorflow-to-onnx-convert/train_data"
GRAPH_DIR="/home/muffadall/work/github_repo/tensorflow-to-onnx-convert/graphs"
...
with mnist_graph.as_default():
    ...
    # Uncomment the following line to see what we have constructed.
    tf.train.write_graph(tf.get_default_graph().as_graph_def(),GRAPH_DIR, "complete.pbtxt", as_text=True)
...
with tf.Session(graph=mnist_graph) as sess:
    ...
    # Write a checkpoint.
    checkpoint_file = os.path.join(CHKPT_DIR, 'checkpoint')
